<template>
  <div class="root">
    <div @click="setActiveImage(images[0])" style="cursor: pointer">
      <SanityImage
        :image="images[0]"
        class="mainImage"
    ...
    <ul class="list">
      ...
      >
        <SanityImage :image="image" class="image" :width="imageWidth" />
      </li>
    </ul>

    <div v-if="activeImage" class="activeImage">
      <svg class="close" @keyup.esc="close" @click="close" viewBox="0 0 96 96">
